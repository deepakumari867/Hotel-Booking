...
const AddRoom = () => {
  ...
  return (
    <div className="w-full">
      ...
      <div className="max-w-2xl text-gray-500 text-sm mt-1 mb-6">
        Fill in the details carefully and accurately — room details,
        ...
        <div className="grid grid-cols-2 sm:flex gap-4 my-2 flex-wrap">
          {Object.keys(images).map((key) => (
            <label htmlFor={`roomImage${key}`} key={key}>
              <img
                className="h-16 cursor-pointer opacity-80"
                src={
                  images[key]
